...
if($pdk.bootloaderVersion!==null&&typeof($pdk.bootloaderVersion)==="object"){if("5"!=$pdk.bootloaderVersion.major||"6"!=$pdk.bootloaderVersion.minor||"8"!=$pdk.bootloaderVersion.revision){alert("Error: Bootloader Version and PDK-JS Version do not match.\n\nSomething is seriously wrong.")
...
}},isFirstClip:function(a){return a.clipIndex==0
},showHideOnFirstClip:function(d){var a=d.baseClip.isAd;
...
if(c.show){e=c;
break
}}if(e&&!a){this.ve.showCaptions(e)
}else{this.ve.hideCaptions(false);
if(a){this.lastSelectedSubtitles=e;
this.hideCaptionsWhenPlaying(true)
...
},iosOnReleaseStart:function(c){this.playlist=c.data;
var d;
for(var a=0;
